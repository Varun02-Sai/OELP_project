% RUN_TEST_5
% Separately runs Test Case 5 and saves plots to a folder
...
cfg = def;
cfg.name = 'Case 5: Clock Recovery / PLL Jitter Failure';
cfg.ffeC0 = 0.85; cfg.ffeC1 = -0.15;
cfg.noiseSigma = 3e-3;              
cfg.enableJitter = true; cfg.rjSigma = 2.0e-12; 

run_and_save_test(cfg, fullfile(pwd, 'Output_TestCase_5'));
